var systemComponents = {
    ...
    'options-tab': {
        ...
        <table>
			...
			<tr>
                <td><button class="opt" onclick="toggleOpt('dandereMode')">Dandere Mode: {{ options.dandereMode?"ON":"OFF" }}</button></td>
				<td><button class="opt" onclick="toggleOpt('imageNode')">Image Nodes: {{ options.imageNode?"ON":"OFF" }}</button></td>
			</tr>  
        </table>`
    },
